...
"""
Adaptation of https://github.com/IvLabs/autonomous-delivery-robot/tree/master/semantic_segmentation
"""

model = load_model('road_dicebce.hdf5', custom_objects = {'loss':loss})
# model = ENet(num_classes=1)
frame = cv2.imread('/home/kushagra/Downloads/DJI_0243/00113.jpg')
frame2 = frame
...
cv2.imwrite('DJI_0243_00113_segmented.jpg', segmented)
