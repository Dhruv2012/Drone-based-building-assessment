...
class Visualization:
    def leftbuildingvisualize(self,leftbuild,cloud):
        print(len(cloud))
        cloud[-4+4].paint_uniform_color([0, 0, 0])
        cloud[-4+5].paint_uniform_color([0, 0, 1])
        cloud[-4+6].paint_uniform_color([1, 0, 0])
        cloud[-4+7].paint_uniform_color([0, 1, 1])
        cloud[-4+8].paint_uniform_color([0, 0.75, 0.25])
        cloud[-4+9].paint_uniform_color([0, 0.25, 0.75])
