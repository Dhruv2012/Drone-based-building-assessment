...
if __name__ == "__main__":
    # print("hello")
    count = 0
    img_path = "/home/kuromadoshi/IIITH/dataset/DJI_0641_mask/Input/"
    mask_path = "/home/kuromadoshi/IIITH/dataset/DJI_0641_mask/masks/"
    roofmask_path ="/home/kuromadoshi/IIITH/dataset/DJI_0641_mask/roof_masks/"
    ...
    for i in range(0, num_img, 1):
        ...
        #     continue
        if(count == 0):
            prev_frame = cv2.imread(img_path + str(j) + '.jpg')
            prev_mask = cv2.imread(mask_path + str(j) + '.jpg')
            prev_roof_mask = cv2.imread(roofmask_path + str(j) + '.png')
            ...
            continue
        cur_frame = cv2.imread(img_path + str(j) + '.jpg')
        cur_mask = cv2.imread(mask_path + str(j) + '.jpg')
        cur_roof_mask = cv2.imread(roofmask_path + str(j) + '.png')
